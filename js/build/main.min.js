...
var KTG={},min_w=300,vid_w_orig,vid_h_orig;KTG.resizeToCover=function(){$("#video-wrap").width($(window).width()),$("#video-wrap").height($(window).height());var i=$(window).width()/vid_w_orig,d=$(window).height()/vid_h_orig,o=i>d?i:d;min_w>o*vid_w_orig&&(o=min_w/vid_w_orig),$("video").width(o*vid_w_orig),$("video").height(o*vid_h_orig),$("#video-wrap").scrollLeft(($("video").width()-$(window).width())/2),$("#video-wrap").scrollTop(($("video").height()-$(window).height())/2)},KTG.appendFirst=function(){$("body").addClass("first-ended")},KTG.hideFirst=function(){$("body").removeClass("first-ended")};