...
function resizeToCover(){$("#video-wrap").width($(window).width()),$("#video-wrap").height($(window).height());var i=$(window).width()/vid_w_orig,o=$(window).height()/vid_h_orig,w=i>o?i:o;min_w>w*vid_w_orig&&(w=min_w/vid_w_orig),$("video").width(w*vid_w_orig),$("video").height(w*vid_h_orig),$("#video-wrap").scrollLeft(($("video").width()-$(window).width())/2),$("#video-wrap").scrollTop(($("video").height()-$(window).height())/2)}var min_w=300,vid_w_orig,vid_h_orig;$(function(){vid_w_orig=parseInt($("video").attr("width")),vid_h_orig=parseInt($("video").attr("height")),$(window).resize(function(){resizeToCover()}),$(window).trigger("resize")});