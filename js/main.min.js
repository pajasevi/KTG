...
var KTG={},min_w=300,vid_w_orig,vid_h_orig;KTG.videos={intro:"videos/intro.mp4","blink-cz":"videos/cz_bliknuti.mp4","blink-en":"videos/en_bliknuti.mp4","park-en":"videos/en_vjezd.mp4","garage-cz":"videos/cz_garaz.mp4"},KTG.resizeToCover=function(){$("#video-wrap").width($(window).width()),$("#video-wrap").height($(window).height());var i=$(window).width()/vid_w_orig,e=$(window).height()/vid_h_orig,o=i>e?i:e;min_w>o*vid_w_orig&&(o=min_w/vid_w_orig),$("video").width(o*vid_w_orig),$("video").height(o*vid_h_orig),$("#video-wrap").scrollLeft(($("video").width()-$(window).width())/2),$("#video-wrap").scrollTop(($("video").height()-$(window).height())/2)},KTG.appendFirst=function(){$("body").addClass("first-ended")},KTG.hideFirst=function(){$("body").removeClass("first-ended")},KTG.videoPlay=function(){},$(function(){vid_w_orig=parseInt($("video").attr("width")),vid_h_orig=parseInt($("video").attr("height")),$(window).resize(function(){KTG.resizeToCover()}),$(window).trigger("resize");var i=videojs("mainVideo");i.src({type:"video/mp4",src:KTG.videos.intro}),i.play(),i.on("ended",function(){KTG.appendFirst()}),$(".lang-link.cz").on("mouseover",function(){i.src({type:"video/mp4",src:KTG.videos["blink-cz"]}),i.play()}),$(".lang-link.en").on("mouseover",function(){i.src({type:"video/mp4",src:KTG.videos["blink-en"]}),i.play()}),$(".lang-link").on("click",function(){i.src({type:"video/mp4",src:KTG.videos["park-en"]}),i.play()})});